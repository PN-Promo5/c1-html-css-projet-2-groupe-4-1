...
function randomFps() {
    return getRandomInt(50, 50)
}
(function() {
    "use strict";

    var canvas = document.querySelector(".bg-tv1"),
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv2"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv3"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv4"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv5"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv6"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv7"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv8"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv9"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    "use strict";
    var canvas = document.querySelector(".bg-tv10"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv11"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv12"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv13"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv14"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv15"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
...
(function() {
    ...
    var canvas = document.querySelector(".bg-tv16"),
        context = canvas.getContext("gl") || canvas.getContext("2d"),
        scaleFactor = 2.5, // Noise size
        samples = [],
        sampleIndex = 0,
